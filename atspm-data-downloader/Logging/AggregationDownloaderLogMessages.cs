...
public partial class AggregationDownloaderLogMessages
{
    ...
    [LoggerMessage(EventId = 1000, EventName = "Download Starting", Level = LogLevel.Information, Message = "Starting Aggregations Stream Download for location {locationId} from {start} to {end}")]
