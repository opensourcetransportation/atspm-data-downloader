...
/// </summary>
public class EventLogDownloaderService : DownloaderServiceBase
{
    /// <summary>
    ...
    public EventLogDownloaderService(
        ...
        ILogger<EventLogDownloaderService> logger)
        : base(serviceProvider, httpClient, options, lifetime, logger, new EventLogDownloaderLogMessages(logger))
    {
    }

    /// <inheritdoc/>
    protected override string BaseRelativePath => "api/v1/EventLog/StreamData";

    /// <inheritdoc/>
    protected override string DatasetLabel => "events";
}
