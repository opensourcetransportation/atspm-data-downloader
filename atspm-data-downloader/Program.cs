...
// for atspm-data-downloader - atspm_data_downloader/Program.cs
// 
...
/// <summary>
/// Entry point class for the ATSPM Data Downloader CLI Utility application.
/// </summary>
public class Program
{
    ...
    {
        var rootCommand = new RootCommand("ATSPM Data Downloader CLI Utility")
        {
            new DownloadCommand()
        };
